...
// Add this guard right after computing totalTests, before the suites loop
if (totalTests === 0) {
  fs.writeFileSync('test-results/email-summary.html',
    '<p style="color:#f9a825;">⚠️ No tests were executed in this run.</p>');
  console.log('⚠️ No tests found — wrote fallback summary.');
  process.exit(0);
}
